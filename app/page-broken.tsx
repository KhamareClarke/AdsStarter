  ...
  return (
    <div>
      ...
      <main className="md:pb-10">
        {/* Social Proof Badge - Top of page */}
        <div className="flex justify-center mb-6 pt-4">
          <AnimatedShinyTextDemo />
        </div>
        
        <section className="relative flex flex-col items-center justify-center min-h-[60vh] px-4 py-16 md:py-32 bg-[#181C22] rounded-xl shadow-xl overflow-hidden mb-10 fade-in">
          {/* Headline */}
        ...
        <div className="md:px-0 mx-6 xl:w-4/5 2xl:w-[68%] md:mx-auto mt-14">
          ...
          <section className="fade-in" className="w-full flex flex-col md:flex-row items-center justify-between gap-8 my-12 px-4 py-10 bg-[#181C22] rounded-2xl shadow-xl border border-[#232c3b] max-w-[1600px] mx-auto relative">
...
<div className="flex-1 flex items-center justify-center w-full mt-10 md:mt-0">
  <section className="fade-in" className="overflow-hidden w-full max-w-lg">
    <InfiniteMovingLogos
      speed="slow"
      direction="left"
      items={[
  ...
  <section className="fade-in" className="w-full bg-[#181C22] rounded-2xl shadow-xl border border-[#232c3b] px-4 md:px-10 py-14 max-w-[1600px] mx-auto my-16">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <section className="fade-in" className="py-20">
  ...
  <li className="flex items-start gap-x-4">
    ...
    <div>
      ...
      <section className="fade-in" className="w-full bg-[#181C22] rounded-2xl shadow-xl border border-[#232c3b] px-2 md:px-4 py-8 max-w-[1600px] mx-auto my-10">
...
<Element name="guarentees">
  <section className="fade-in" className="w-full bg-[#181C22] rounded-2xl shadow-xl border border-[#232c3b] px-4 md:px-10 py-14 max-w-[1600px] mx-auto my-16">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <section className="fade-in" className="my-10 md:py-20 xl:w-4/5 2xl:w-[68%] md:mx-auto">
  ...
  <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row md:justify-between md:items-start gap-12 md:gap-20">
    ...
    <div className="flex-1 flex flex-col items-center md:items-start gap-2">
      ...
      <Link href="/" className="text-blue-400 hover:underline">Home</Link>
            <Link href="/meeting" className="text-blue-400 hover:underline">Book a Call</Link>
